...
pub use types::{MetricKind, MetricRecord};

/// Local sync metrics export hook — backward-compatible with core's internal usage.
...
#[async_trait]
impl antikythera_ports::observability::MetricsExporter for InMemoryMetricsExporter {
