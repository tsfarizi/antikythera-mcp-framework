...
use antikythera_core::logging::SessionLogger;
use antikythera_core::domain::message_types::Message;
use antikythera_core::domain::session_manager::SessionManager;
...
impl SessionStore {
    ...
    pub fn touch_or_create(&mut self, session_id: &str) {
    ...
    pub fn replace_history(&mut self, session_id: &str, messages: Vec<ChatMessage>) {
